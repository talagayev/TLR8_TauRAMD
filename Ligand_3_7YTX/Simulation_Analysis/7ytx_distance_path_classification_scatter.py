...
for folder_num in range(1, 6):  # Adjust the range if you have more folders
    ...
    for i in range(1, 21):  # Adjust the range if you have more files
        ...
        residue_ex = u.select_atoms("resnum 67 and resname PHE")
        residue_in = u.select_atoms("resnum 32")
...
plt.title('Unbinding Pathway Ligand 3', fontsize=20, pad=15)
...
plt.savefig('scatter_7ytx_final_outlier.png')
