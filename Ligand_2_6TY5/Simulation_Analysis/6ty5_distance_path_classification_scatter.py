...
for folder_num in range(1, 6):  # Adjust the range if you have more folders
    ...
    for i in range(1, 21):  # Adjust the range if you have more files
        ...
        residue_ex = u.select_atoms("resnum 66 and resname PHE")
        residue_in = u.select_atoms("resnum 31")
...
plt.title('Unbinding Pathway Ligand 2', fontsize=20, pad=15)
...
plt.savefig('scatter_6ty5_outlier.png')
