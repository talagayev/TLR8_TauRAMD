...
# Initialize lists to store minimal distances to residues 64 and 110
...
for folder_num in range(1, 6):  # Adjust the range if you have more folders
    ...
    for i in range(1, 21):  # Adjust the range if you have more files
        ...
        residue_ex = u.select_atoms("resnum 89")
        residue_in = u.select_atoms("resnum 34")
...
# Label the axes
plt.xlabel('Minimum Distance to Asp545* (Å)', fontsize=17)
plt.ylabel('Minimum Distance to Asn491 (Å)', fontsize=17)
plt.title('Unbinding Pathway Ligand 1', fontsize=20, pad=15)
...
plt.savefig('scatter_3w3l_outlier.png')
